...
The detection of low-quality cells plays an important part in sequencing data quality control. This section will help you quickly overview the basics information of different low-quality detection methods. This section contains three aspects:

- [**QC scatter plot**:]{style=\"color:red\"} The distribution scatter plots of QC metrics.
- [**Filtered information**:]{style=\"color:red\"} The filtered results of different methods.
- [**Upset**:]{style=\"color:red\"} Upset plot to show the overlap between different methods.
")
 cat('\n\n') 
}
...
if(!is.null(data$Cell$Section1$lq_Filtration)){
  ...
  cat('### Filtered information {.tabset .unnumbered} \n')
...
Another key issue in cell QC is the detection of doublets, which can affect the annotation accuracy of cell types. This section will help you quickly check the basics information of different doublet detection methods. This section contains two aspects:

- [**Filtered information**:]{style=\"color:red\"} The filtering results of different methods. 
- [**Upset**:]{style=\"color:red\"} Upset plot to show the overlap between different methods.
")
  cat('\n\n')
}

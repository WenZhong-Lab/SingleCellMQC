...
generate_primary_card <- function(
  ...
  generate_bs_card(
    ...
    header_bg = NULL, # Primary 风格通常header没有特定背景，或者和body一致
    body_bg = NULL,   # Primary 风格的body通常没有特定背景，或者默认白色
    text_color = NULL, # Primary 风格的文字通常是默认的深色
    border_color = "black", # 特定的黑色边框
...
generate_info_card <- function(
  ...
  generate_bs_card(
    ...
    card_title = card_title,
    body_content = body_content,
    header_bg = "info",    # Header 背景色为 info (蓝色)
    body_bg = "info",      # Body 背景色为 info (蓝色)
    text_color = "white",  # 文字颜色为白色
    border_color = "info", # 边框颜色为 info (蓝色)
    card_class = card_class
  )
}
...
generate_light_card <- function(
  ...
  generate_bs_card(
    ...
    card_title = card_title,
    body_content = body_content,
    header_bg = "light",   # Header 背景色为 light (浅灰色)
    body_bg = "light",     # Body 背景色为 light (浅灰色)
    text_color = "black",   # 文字颜色为深色
    border_color = "light", # 边框颜色为 light (浅灰色)
    card_class = card_class
  )
}
```
...
```{r, results='asis'}
generate_bs_card(
  header_content = "Header", # 卡片头部内容
  card_title = "Primary card title", # 卡片主体内部的标题
  body_content = "Some quick example text to build on the card title and make up the bulk of the card's content.", # 卡片主体内容
  border_color = "black", # 设置外框颜色为深色
  card_class = "mb-4"    # 添加底部外边距
)
# Card 2: Info 样式 (蓝色背景，白色文字，Header 也是蓝色背景)
generate_bs_card(
  header_content = "Header",
  card_title = "Info card title",
  body_content = "Some quick example text to build on the card title and make up the bulk of the card's content.",
...
# Card 3: Light 样式 (浅灰色背景，深色文字，Header 也是浅灰色背景)
generate_bs_card(
  header_content = "Header",
  card_title = "Light card title",
  body_content = "Some quick example text to build on the card title and make up the bulk of the card's content.",
...
generate_primary_card(
  header_content = "Primary Header",
    card_title =NULL,
  body_content = "This is a card with a black border, typical for a primary style."
)
